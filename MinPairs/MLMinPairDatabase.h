...
/**
 * This class stores/reads quiz or practice results in sqlite database. Inherits from MLDatabase class.
 */
@interface MLMinPairDatabase : MLDatabase
...
/*! Constructs instance of MLMinPairDatabase class
 * \returns instance of MLMinPairDatabase class
 */
-(instancetype)initMinPairDataBase;
...
/*
 ...
 MLMinPairDatabase* db = [[MLMinPairDatabase alloc]initMinPairDataBase];
