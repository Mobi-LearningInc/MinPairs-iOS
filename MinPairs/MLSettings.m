...
+(MLSettings*) sharedInstance
{
    ...
    dispatch_once(&onceToken, ^{
        NSString* DB_CREATE_QUERY = [NSString stringWithFormat:@"CREATE TABLE IF NOT EXIST %s (%s INTEGER PRIMARY KEY AUTOINCREMENT, %s INTEGER, %s INTEGER, %s INTEGER);", DB_TABLE_NAME, DB_SETTINGS_ID, DB_TIME_LISTEN_AND_SELECT_COL_NAME, DB_TIME_LISTEN_AND_READ_COL_NAME, DB_LISTEN_AND_TYPE_QUESTION_COL_NAME];
